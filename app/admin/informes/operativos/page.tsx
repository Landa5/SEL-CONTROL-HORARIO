...
function OperationalReportsContent() {
    ...
    const defaultTab = searchParams.get('tab') === 'personnel' ? 'personnel' : 'fleet';
    ...
    const fleetContent = (
        <div className="space-y-8 animate-in fade-in duration-500 pb-12">
            ...
            {loading && !data ? (
                <div className="p-12 text-center text-gray-500 animate-pulse">Cargando informes...</div>
            ) : (
                <>
                    {(() => {
        ...
        <div className="space-y-4">
            <Tabs defaultValue={defaultTab} className="w-full">
                <TabsList className="grid w-full grid-cols-2 max-w-sm mb-4">
                    <TabsTrigger value="personnel">Diario Personal</TabsTrigger>
                    <TabsTrigger value="fleet">Flota Mensual</TabsTrigger>
                </TabsList>
...
export default function OperationalReportsPage() {
    return (
        <Suspense fallback={<div className="p-12 text-center text-gray-500 animate-pulse">Cargando...</div>}>
